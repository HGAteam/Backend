...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://hgateam.com";
        var useCsrf = Boolean();
...
<body data-languages="[&quot;bash&quot;,&quot;javascript&quot;,&quot;php&quot;,&quot;python&quot;]">
                ...
                <ul id="tocify-subheader-api-autenticacion" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="api-autenticacion-POSTapi-login">
                        <a href="#api-autenticacion-POSTapi-login">Iniciar sesión y obtener un token de acceso
                            ...
                            Para acceder a los recursos protegidos de la API, debes usar el token generado en el
                            ...
                            **IMPORTANTE:**
                            ...
                            - Una vez autenticado, el token obtenido debe ser enviado en todas las solicitudes
                            protegidas.</a>
                    </li>
                    <li class="tocify-item level-2" data-unique="api-autenticacion-POSTapi-register">
                        <a href="#api-autenticacion-POSTapi-register">Registrar un nuevo usuario
                            ...
                            Este endpoint permite registrar un nuevo usuario en la API. No se necesita autenticación
                            para esta solicitud.</a>
                    </li>
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <aside>
                <strong>Base URL</strong>: <code>https://hgateam.com</code>
            </aside>
...
You can switch the language used with the tabs at the top right (or from the nav menu at the top left on mobile).&lt;/aside&gt;</code></pre>
            ...
            <p>To authenticate requests, include an <strong><code>Authorization</code></strong> header with the value
                <strong><code>"Bearer {ACCESS_TOKEN}"</code></strong>.
            </p>
            ...
            <h2 id="api-autenticacion-POSTapi-login">Iniciar sesión y obtener un token de acceso
                ...
                Este endpoint permite iniciar sesión con un usuario registrado.
                Para acceder a los recursos protegidos de la API, debes usar el token generado en el encabezado
                `Authorization`.
...
$url = 'https://hgateam.com/api/login';
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-login" data-method="POST" data-path="api/login" data-authed="0"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="email" data-endpoint="POSTapi-login"
                        value="usuario@ejemplo.com" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="password" data-endpoint="POSTapi-login"
                        value="secret" data-component="body">
                    <br>
            ...
            <h2 id="api-autenticacion-POSTapi-register">Registrar un nuevo usuario
                ...
                Este endpoint permite registrar un nuevo usuario en la API. No se necesita autenticación para esta
                solicitud.</h2>
            ...
            <span id="example-requests-POSTapi-register">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "https://hgateam.com/api/register" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Juan Pérez\",
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/register';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
            ...
            <form id="form-POSTapi-register" data-method="POST" data-path="api/register" data-authed="0"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-register"
                        value="Juan Pérez" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="password_confirmation"
                        data-endpoint="POSTapi-register" value="secret" data-component="body">
                    <br>
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/logout';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-logout" data-method="POST" data-path="api/logout" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-logout" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" data-endpoint="POSTapi-logout"
                        value="Bearer <TOKEN>" data-component="header">
                    <br>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-logout"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-logout"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
    ...
    --get "https://hgateam.com/api/is-authenticated" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://hgateam.com/api/is-authenticated"
);
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/is-authenticated';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;message&quot;: &quot;Usuario no autenticado.&quot;
            ...
            <span id="execution-results-GETapi-is-authenticated" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-is-authenticated"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-is-authenticated" data-method="GET" data-path="api/is-authenticated"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-is-authenticated" onclick="tryItOut('GETapi-is-authenticated');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-is-authenticated" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization"
                        data-endpoint="GETapi-is-authenticated" value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-is-authenticated" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
            ...
            <span id="example-requests-GETapi-people">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://hgateam.com/api/people?limit=5&amp;offset=10" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/people';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;error&quot;: &quot;Detalles del error&quot;
            ...
            <span id="execution-results-GETapi-people" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-people"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-people" data-method="GET" data-path="api/people" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-people" onclick="tryItOut('GETapi-people');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-people" onclick="cancelTryOut('GETapi-people');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-people" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-people"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" data-endpoint="GETapi-people"
                        value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-people"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="number" style="display: none" step="any" name="limit"
                        data-endpoint="GETapi-people" value="5" data-component="query">
                    <br>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="offset"
                        data-endpoint="GETapi-people" value="10" data-component="query">
                    <br>
            ...
            <span id="example-requests-GETapi-people--id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://hgateam.com/api/people/1" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
    --header "Content-Type: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://hgateam.com/api/people/1"
);
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/people/1';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;error&quot;: &quot;Detalles del error&quot;
            ...
            <span id="execution-results-GETapi-people--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-people--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-people--id-" data-method="GET" data-path="api/people/{id}" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-people--id-" onclick="tryItOut('GETapi-people--id-');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-people--id-" onclick="cancelTryOut('GETapi-people--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-people--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-people--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization"
                        data-endpoint="GETapi-people--id-" value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-people--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="GETapi-people--id-" value="1" data-component="url">
                    <br>
            ...
            <span id="example-requests-GETapi-planets">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://hgateam.com/api/planets?limit=5&amp;offset=10" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
    --header "Content-Type: application/json"</code></pre>
                </div>
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/planets';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;error&quot;: &quot;Detalles del error&quot;
            ...
            <span id="execution-results-GETapi-planets" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-planets"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-planets" data-method="GET" data-path="api/planets" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-planets" onclick="tryItOut('GETapi-planets');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-planets" onclick="cancelTryOut('GETapi-planets');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-planets" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-planets"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" data-endpoint="GETapi-planets"
                        value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-planets"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="limit"
                        data-endpoint="GETapi-planets" value="5" data-component="query">
                    <br>
                    <p>Número de registros por página. Default: 10. Example: <code>5</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="offset"
                        data-endpoint="GETapi-planets" value="10" data-component="query">
                    <br>
                    <p>Número de registros a omitir. Default: 0. Example: <code>10</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-GETapi-planets--id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://hgateam.com/api/planets/1" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
    --header "Content-Type: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://hgateam.com/api/planets/1"
);
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/planets/1';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;error&quot;: &quot;Detalles del error&quot;
            ...
            <span id="execution-results-GETapi-planets--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-planets--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-planets--id-" data-method="GET" data-path="api/planets/{id}" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-planets--id-" onclick="tryItOut('GETapi-planets--id-');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-planets--id-" onclick="cancelTryOut('GETapi-planets--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-planets--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-planets--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization"
                        data-endpoint="GETapi-planets--id-" value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-planets--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="GETapi-planets--id-" value="1" data-component="url">
                    <br>
            ...
            <span id="example-requests-GETapi-vehicles">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://hgateam.com/api/vehicles?limit=5&amp;offset=10" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
    --header "Content-Type: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://hgateam.com/api/vehicles"
);
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/vehicles';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;error&quot;: &quot;Detalles del error&quot;
            ...
            <span id="execution-results-GETapi-vehicles" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-vehicles"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-vehicles" data-method="GET" data-path="api/vehicles" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-vehicles" onclick="tryItOut('GETapi-vehicles');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-vehicles" onclick="cancelTryOut('GETapi-vehicles');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-vehicles" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-vehicles"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" data-endpoint="GETapi-vehicles"
                        value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-vehicles"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="limit"
                        data-endpoint="GETapi-vehicles" value="5" data-component="query">
                    <br>
                    <p>Número de registros por página. Default: 10. Example: <code>5</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="offset"
                        data-endpoint="GETapi-vehicles" value="10" data-component="query">
                    <br>
                    <p>Número de registros a omitir. Default: 0. Example: <code>10</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-GETapi-vehicles--id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "https://hgateam.com/api/vehicles/1" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer &amp;lt;TOKEN&amp;gt;" \
    --header "Content-Type: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "https://hgateam.com/api/vehicles/1"
);
...
fetch(url, {
    ...
    headers,
                ...
                <div class="php-example">
                    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://hgateam.com/api/vehicles/1';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;error&quot;: &quot;Detalles del error&quot;
            ...
            <span id="execution-results-GETapi-vehicles--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-vehicles--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-vehicles--id-" data-method="GET" data-path="api/vehicles/{id}" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-vehicles--id-" onclick="tryItOut('GETapi-vehicles--id-');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-vehicles--id-" onclick="cancelTryOut('GETapi-vehicles--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-vehicles--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-vehicles--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization"
                        data-endpoint="GETapi-vehicles--id-" value="Bearer <TOKEN>" data-component="header">
                    <br>
                    <p>Example: <code>Bearer &lt;TOKEN&gt;</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-vehicles--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="GETapi-vehicles--id-" value="1" data-component="url">
                    <br>
...
<?php /**PATH C:\xampp\htdocs\backend\resources\views/scribe/index.blade.php ENDPATH**/ ?>